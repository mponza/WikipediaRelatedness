package it.unipi.di.acubelab.wikipediarelatedness.evaluation.metrics
...
object Correlation {
  ...
  /**
    ...
    * @return
    */
  def pearson(dataset: WikiRelDataset) = {
  ...
  /**
    ...
    * @return
    */
  def spearman(dataset: WikiRelDataset) = {
    humanAndMachineScores(dataset) match {
  ...
  /**
    ...
    * @return
    */
  protected def humanAndMachineScores(dataset: WikiRelDataset) : (Array[Double], Array[Double]) = {
