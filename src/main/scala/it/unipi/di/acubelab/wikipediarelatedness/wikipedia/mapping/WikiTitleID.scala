...
object WikiTitleID {
  ...
  /**
    ...
    * @return
    */
  protected def loadMapping() : Object2IntOpenHashMap[String] = {
    if(new File(serializedPath).exists()) return BinIO.loadObject(serializedPath)
                                                        .asInstanceOf[Object2IntOpenHashMap[String]]
