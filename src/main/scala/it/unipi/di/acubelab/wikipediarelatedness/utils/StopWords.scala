...
object StopWords {
  ...
  protected val WIKIMEDIA_STOPWORDS = ("a about above after again against all am an and any are aren't as at be because been before being below " +
  ...
  protected val stopwords =  {
    val stopSet = new ObjectOpenHashSet[String]()
    WIKIMEDIA_STOPWORDS.foreach(stopSet.add)
  ...
  def getStopWordList = WIKIMEDIA_STOPWORDS
  def getStopWordSet = stopwords
}
